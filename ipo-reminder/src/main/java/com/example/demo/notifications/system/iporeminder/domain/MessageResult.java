package com.example.demo.notifications.system.iporeminder.domain;

import com.example.demo.notifications.system.iporeminder.common.BaseEntity;
...
@Getter
@Entity
@Table(indexes = @Index(name = "idx_uid_created_at", columnList = "uid, created_at"))
